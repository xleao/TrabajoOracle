...
ALTER PACKAGE APP_CLINICA.PKG_CITAS COMPILE BODY;
...
SELECT APP_CLINICA.SEQ_NOTIFICACIONES.NEXTVAL, CITA_ID, PACIENTE_ID, 'RECORDATORIO', 'Le recordamos que tiene una cita médica programada en las próximas 24 horas.', 'N'
